...
internal class TestAuthInterceptor : Interceptor
{
    ...
    private readonly Func<NodeId> _getNodeId;
    private readonly ILogger<TestAuthInterceptor> _logger;

    public TestAuthInterceptor(Func<NodeId> getNodeId, ILoggerFactory loggerFactory)
    {
        _logger = loggerFactory.CreateLogger<TestAuthInterceptor>();
